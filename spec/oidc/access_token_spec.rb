...
describe Oidc::AccessToken do
  ...
  context 'when id_token is given' do
    ...
    context 'when IdToken object' do
      ...
      its(:id_token) { should be_a Oidc::ResponseObject::IdToken }
    ...
    context 'when forbidden' do
      it 'should raise Oidc::Forbidden' do
        mock_json :get, endpoint, 'errors/insufficient_scope', :HTTP_AUTHORIZATION => 'Bearer access_token', status: 403 do
          expect { request }.to raise_error Oidc::Forbidden
        end
      end
    end

    context 'when unknown' do
      it 'should raise Oidc::HttpError' do
        mock_json :get, endpoint, 'errors/unknown', :HTTP_AUTHORIZATION => 'Bearer access_token', status: 500 do
          expect { request }.to raise_error Oidc::HttpError
        end
      end
    end
  end
  ...
  describe '#userinfo!' do
    it do
      ...
      userinfo.should be_instance_of Oidc::ResponseObject::UserInfo
    end
