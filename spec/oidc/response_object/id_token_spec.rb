...
describe Oidc::ResponseObject::IdToken do
  let(:klass)       { Oidc::ResponseObject::IdToken }
    ...
    context 'when both issuer, client_id are valid' do
      ...
      context 'when expired' do
        ...
        it do
          ...
          end.to raise_error Oidc::ResponseObject::IdToken::InvalidToken
        end
      end
    end
  ...
  describe '.decode' do
    ...
    context 'when IdP config is given' do
      ...
      let(:idp_config) do
        Oidc::Discovery::Provider::Config::Response.new(
    ...
    context 'when self-issued' do
      ...
      context 'when invalid subject' do
        ...
        it do
          expect do
            klass.decode self_issued, :self_issued
          end.to raise_error Oidc::ResponseObject::IdToken::InvalidToken, 'Invalid subject'
        end
      end
      ...
      context 'when no sub_jwk' do
        ...
        it do
          expect do
            klass.decode self_issued, :self_issued
          end.to raise_error Oidc::ResponseObject::IdToken::InvalidToken, 'Missing sub_jwk'
        end
      end
    end
  end
