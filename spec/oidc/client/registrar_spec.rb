...
describe Oidc::Client::Registrar do
  subject { instance }
  ...
  let(:instance) { Oidc::Client::Registrar.new(endpoint, attributes) }
  ...
  context 'when endpoint given' do
    ...
    context 'otherwise' do
      let(:instance) { Oidc::Client::Registrar.new(endpoint) }
  ...
  describe '#as_json' do
    ...
    context 'otherwise' do
      ...
      it do
        expect do
          instance.as_json
        end.to raise_error Oidc::ValidationFailed
      end
    end
  end

  describe '#register!' do
    it 'should return Oidc::Client' do
      client = mock_json :post, endpoint, 'client/registered', params: minimum_attributes do
        instance.register!
      end
      client.should be_instance_of Oidc::Client
    ...
    context 'when failed' do
      it 'should raise Oidc::Client::Registrar::RegistrationFailed' do
        mock_json :post, endpoint, 'errors/unknown', params: minimum_attributes, status: 400 do
          expect do
            instance.register!
          end.to raise_error Oidc::Client::Registrar::RegistrationFailed
        end
      end
    end
  end
    ...
    context 'when valid' do
      it do
        expect do
          ...
          e.should be_a Oidc::ValidationFailed
        }
      end
    end
