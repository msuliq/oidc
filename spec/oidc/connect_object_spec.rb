...
describe Oidc::ConnectObject do
  class Oidc::ConnectObject::SubClass < Oidc::ConnectObject
  ...
  subject        { instance }
  let(:klass)    { Oidc::ConnectObject::SubClass }
  ...
  describe '#as_json' do
    ...
    context 'otherwise' do
      ...
      it 'should raise Oidc::ValidationFailed with ActiveModel::Errors owner' do
        expect { instance.as_json }.to raise_error(Oidc::ValidationFailed) { |e|
  ...
  describe '#validate!' do
    ...
    context 'otherwise' do
      ...
      it 'should raise Oidc::ValidationFailed with ActiveModel::Errors owner' do
        expect { instance.validate! }.to raise_error(Oidc::ValidationFailed) { |e|
          e.message.should include 'Required is not included in the list'
          e.message.should include 'Required is too long (maximum is 10 characters)'
          e.object.errors.should be_a ActiveModel::Errors
        }
