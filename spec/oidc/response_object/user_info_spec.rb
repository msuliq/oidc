...
describe Oidc::ResponseObject::UserInfo do
  let(:klass) { Oidc::ResponseObject::UserInfo }
  ...
  describe '#address=' do
    context 'when Hash is given' do
      ...
      its(:address) { should be_a Oidc::ResponseObject::UserInfo::Address }
    end

    context 'when Address is given' do
      let :attributes do
        {address: Oidc::ResponseObject::UserInfo::Address.new}
      end
      its(:address) { should be_a Oidc::ResponseObject::UserInfo::Address }
    end
  end
